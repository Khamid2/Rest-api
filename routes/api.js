...
var creator = 'Khamid' // ubah jadi nama lu
const listkey = ["Cyberklik", "Zeeone", "ZeeoneOfc"]; // ubah apikey nya, tambah aja klo mau
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: `Apikey tidak ditemukan! Silahkan kontak Owner untuk dapatkan Apikey wa.me/6282322888788`
    },
    noturl: {
    	status: false,
    	code: 403,
...
var invalidKey = __path + '/public/invalidKey.html' // Apikey Invalid
var len = 15
 ...
 router.get('/cekapikey', async (req, res, next) => {
	...
	var limit = 'undefined'
        if (apikeyInput == `${listkey}`) { limit = 'Unlimited!' }
