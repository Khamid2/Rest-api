...
var x = setInterval(function() {
  ...
  var seconds = Math.floor((distance % (1000 * 60)) / 1000);
   ...
   // Menampilkan Hasil Di Dalam element Menggunakan id="hitungMundur"
  document.getElementById("hitungMundur").innerHTML = days + " Days " + hours + " Hours "
  + minutes + " Min " + seconds + " Sec ";
  if (distance < 0) {
    clearInterval(x);
    // Ketika countdown timer sudah berakhir
    document.getElementById("hitungMundur").innerHTML = "Selamat Tahun baru";
  }
}, 1000);
